...
if TYPE_CHECKING:
    from src.ecs.components.ai import BaseAI
    from src.ecs.components.consumable import Consumable
    from src.ecs.components.equipment import Equipment
    from src.ecs.components.equippable import Equippable
    from src.ecs.components import Fighter
